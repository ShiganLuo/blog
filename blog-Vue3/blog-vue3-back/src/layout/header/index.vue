...
const menuWidth = ref(staticStore.menuWidth)
const handleMenuWidth = () => store.commit('HANDLE_MENU_WIDTH')
...
<template>
  <el-affix :offset="0">
    <div class="header flex text-light-50 top-0 right-0 left-0 items-center">
      <!-- 展开、收缩侧边栏 -->
      <el-icon class="icon-btn" @click="handleMenuWidth">
        <Fold v-if="menuWidth === '250px'" />
        <Expand v-else />
      </el-icon>
      ...
      <div class="ml-auto flex justify-center items-center">
        ...
        <el-dropdown class="dropdown flex justify-center items-center text-light-50 mx-5" @command="handleCommand">
          <span class="flex justify-center items-center">
            <el-avatar :size="25" :src="user.avatar" class="mr-2" />
            {{ user.username }}
